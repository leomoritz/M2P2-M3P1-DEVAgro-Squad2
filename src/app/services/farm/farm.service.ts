...
import { IFarm, IFarmPut } from 'src/app/model/interfaces/farm/ifarm';
import { IFarmNextHarvest } from 'src/app/model/interfaces/farm/ifarm-next-harvest';
import { IGrainCompanyLoggedIn } from 'src/app/model/interfaces/grain/grain';
